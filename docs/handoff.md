...
- ブランチ：`main`
- 最新コミット：`e8e4ecc content: complete grade 3 kanji review`
- 最新素材版：`2026.08.15-4`
...
2. **実画面での確認**。エサ1/3/5ポイントの消費、エフェクトとお礼、5段階の見た目の変化、3日放置後のしょんぼり表示と1問回答での即時回復、1匹目を500ポイントで育て終えたときの2匹目への切り替え。
